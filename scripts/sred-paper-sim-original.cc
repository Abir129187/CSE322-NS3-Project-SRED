...
main(int argc, char* argv[])
{
    ...
    double simTime = 50.0;
    std::string queueDiscName = "ns3::SredQueueDisc";
    ...
    Config::SetDefault("ns3::SredQueueDisc::MaxTh", DoubleValue(500000));
    // Smoother EWMA for hit probability estimate
    Config::SetDefault("ns3::SredQueueDisc::HitProbEwma", DoubleValue(0.0002));
